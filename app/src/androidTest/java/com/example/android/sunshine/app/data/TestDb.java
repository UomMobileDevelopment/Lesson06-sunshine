...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        ContentValues testValues = TestUtilities.createThessalonikiLocationValues();

        // Insert ContentValues into database and get a row ID back
        long thessRowId;
        thessRowId = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, testValues);

        //Verify we got a row back
        assertTrue(thessRowId != -1);
        ...
        //Move the cursor to demonstrate that there is only on record in the database
    ...
    public void testWeatherTable() {
        ...
        long id = TestUtilities.insertNorthPoleLocationValues(mContext);
